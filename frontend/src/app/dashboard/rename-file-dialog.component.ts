...
export class RenameFileDialogComponent {
  private readonly dialogRef = inject(MatDialogRef<RenameFileDialogComponent, string | null>);
  protected readonly data = inject<RenameFileDialogData>(MAT_DIALOG_DATA);

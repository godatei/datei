...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xcX3PbuBH/Khi2M41nJMvppZ3WfXIS5+rO+eJJnN5D6geYXElISIABllZUj797B/9I",
	"igRIWbKSdOaeLkeBu4vdxQ/7j75PUlGUggNHlZzeJypdQkHNP8+y7LygLH8HXypQqB+VUpQgkYFZAPpX",
	"/Y+5kAXF5NQ9mSS4LiE5TRRKxhfJw8MkkfClYhKy5PSjW3VTLxO3nyDF5GGSvBJ8zmTxDhTgFVVqJWQW",
	"ZV+6BfrfBeO/AF/gMjn92xj7+r2gBBIowmuKwKKM5ywH/d8MVCpZiUzw5DR5w3IgGUVKngnzjOYTIgqG",
	"ZC4kyZiEFIVkoI6SSaOxW8apXPdVNkk4LQJcfqUFGIK4BMJhRYyoofdLKoHjRdancWV+qUVak4vX5Fkt",
	"qRQCN0SsKpYFbdpTnpWlp690CelnVRURnfmfyTNe5XlIW/o5vdVKR1lBYK+p4AgcLwObvaTycyZWnLg1",
	"pJRwx2C1FVnjDNkZ9skaP2GCE2QFKKRF2VZZRhGm+pckTvXluk/1gwKprSHmxKwSMmCIUbFZQA0fOPtS",
	"AWEZcGRzBnLcwpOEqdfeR/oUf1sCLkE7IlOEKUIbh2po3QqRA+WaWM74Z8iMi4Sc0u7aLrJOTZ5pV1Dr",
	"Qj9UR7toomAFXJuHPbe4uDwnev0eXhc+oa8qaY6X/lVvSR9Uf0hHST7q0O6iEcX+G8Mu/RNhnNyuEVRc",
	"LTVLxvGvL+I8GUdYgNRMUVK1DJ+ja/3T+CEa3ZdjMXSoVktB3DLCcBflVWUWw4NfqEJif98BEhzhMenz",
	"hsluW+jchPYVamRqn/U28rV3fRPD/CuKywuEoo/9FotGkcYfpZhdW7/VkBLdTFBMprReLt+cbRVP7BFB",
	"nPMxRqnIYJyJWTXCQJWCK+hzkJCKO5DrVyJzZkAoVFjB9gGVkq57MmzSCQnzC1PooqWYMDXvTcc+0xw1",
	"QFqwtySV9kS//o8S5slp8odZE6LOXHw6s4jak3+SoECaB3BGPya8Km5BaqaGCXl2C3MhgZR0wbi5z4+S",
	"PoB1Hc3I5znFlGJCZxXXigmCN/UztF8NA4bkqM0c4ZhcBnB3N5YH0J2Mdm1f/rFtJxaMmzxkMXS+Fkyh",
	"NFztcdwGoUJvRUXYP+uaJMWcvgpjzeQRaOfJD6KekzmuMENPXc5pSFHaIJ+Bh2Xp8TLQ1wKm90ixUkPM",
	"C8o444saDke8pPNCaL/vYAEcJEXoSnPo+2WI8/e/D94ZHwf5FO4bDQp2zfw9JxfyjKh5mxrE05dA3gNW",
	"5eDl/kVq9X+QeVA3ClIJOO5jbt2kRS4kzgZkn94nNM/fzpPTj9vdzl3RhWQLxnW0GMhBdL5BeQoKhSQl",
	"xaXPnspu6kPRPNfRdH0nMb44JleirHITHQuer+tyxjSHO8jtOn97rJbASc4UMr4gK4ZLUSHx6dfRMTkv",
	"SlwTs0rz0m+RFVWatyZJDMnj//BHBSx1nPwQDdXDB6/JoPpGunmYJB9MjD5ctooUlGBlU1VfVHK5t69h",
	"He2XtmryZajeZNLLQtyBIiiMSv9hjVYpyKzebeJx5WgTpohmf7R75nYVFbMuZggjU0sRKAg1hbbuLuJs",
	"2/d/70C1LPUbw6XOvB9ZaNQqnfeLjeGy4o5FjN+94nt4RR3kf8P7puEcz1dtResqHr880V3dF67OevpC",
	"tWuz21VZHhF6bFm2YOpKsoLa8mg/qL0DyeZs++qFF6ch26LRLsrcRHQVDxqKOR1IVKL260jpAqcWsb4k",
	"NgapJMP1e333Wf63QCXIfyKWZxUugSNLqT1l/rc3Xtn/+u06mXRO4kuzhJgsgVRK39mU2IXmgoV6TWOm",
	"JWKZPGh5GJ8LszmG+ljamhU5u7qw+lWWx/Pjk+MTrQtRAqclS06Tn8wj7cS4NNuY0ZLN7p7PaIXLWa5z",
	"HqNqYY+NVrjZlQYTmxIlVoGg8KXI1rb6Y/oQJpgqy9zpYfZJWWXYeGEsmthIER82zaRRxzywvmDk/vPJ",
	"yVPzdp5mmHdqoXoBUVWaglLzKidCkss3Z6QW8WGSvDh5HugB8Duas4ykEkyfgubKv2uqYW3fSk4/3kwS",
	"VRX2+GmmhHETyRFzjgjlGanRR7/aN94sNYm+lmQBARP+DNiqBySHVmqn7BBVrZW6soIOauVnQJJH3tlQ",
	"h3R5W9ydfWZ3II/uJo5bOfWLvg+9axVZWj5ofe4k7nOMlxVqb3POk0ug2Zp4vXiv/WmEY2brzNmgVfxe",
	"XQxRKf3PNBUVx5BllHXNmFlaeerBbBPIhXc3kAJ0WlbAcURThhmh9Ukmsnl/Q1mZT1GDJ7muUxs0l7QA",
	"BKlMIrtLc1zjfvKlAhvwmbuzCXcnLbWOdtH7/eqvrKiKVrlTgqpyW2QNcM1ZYTpBDcsM5rTKMTl9fnIS",
	"Koj2gvEuJx3dqs+sjHAU87mCCMsQw5tDwmav/RACTaawbjSMAoHZLWn5SMc/h2KZjzcPm5eS5kzzvGEd",
	"PsStqZPBI1xUObKSSpxpv5rqBHB7XQVGW7Y6w8+fzFpOC30L2YDMxbct1M7XLXNtLUIn8gWl6GKL4NYv",
	"DIS0PYG9s0ivSC3l3wPDAILPc5YieQbHi+NJP+nlQgNLxbOjffzMmtZdJ17LHWic3bPswUqYA0LfCV+b",
	"51uBpLWXmUAwCKHj4wYgmL+HGq96DCTebHOLWAnsVkIeE32lVnjcZpTrRZa2N9ymxaAocb2XxayyCW0h",
	"A8V02bdKq170/a2yTWjxdbparaYGnyqZA9eRe7Y9RgQqmVrNeyHfQM3tG+dOIwjoZzsiCLgFBm3j97t7",
	"rVVk47VBjJllYsVzQbNoMPbaLfgRsWbI1iJFwKlCCbRITu/7VrTzjO7lSbIEmplN3euLQD+cvmaqFIr5",
	"0keny45I02Whbwj7qk1n5ywHV3lpdta/yzyLsYE311UxxeUhig9PBaTO2h5KN2cF90NRT3rEI0vXcYol",
	"+XVz5v/IGfvAs1sfqtN36vn0W5np9Nf0yrTv+BadInMpCtsMQ2FcasHugPtWAeNpXil2B0ffApl+BtsT",
	"7DUQnWc0wsZ8BJdVcctdhXjQUa7rld/TWyb3lqhFiobsxXz6q+AwvTTxxNABH/c3VtAFzD6VsAjCXa0I",
	"YhZ2EI+mS5hqUJIi33TUPnadX9PF8Bq96qeQE/0qkFyKzBbJt/Q0IiRZUkW4qMfC14BjQObnLkjtKlFI",
	"myQvnv8lNIWtqrIUUt/xBWSMWkS2TTZP07EJlPYefyA8Tc0hhJEKEBlfqFkzjhYtn9iJtuTA2Xxnbm4g",
	"nXci75uem+qbpxVL0P23MAcqsHU/tdm1tnZua5dZ5o/CQNhoK3DaL1ypk3Gti330eZZlLgftl+c6nja7",
	"N/+9GE5J30Eh7uC8CGJtAFIdzcOnn1bR0ogXV7XDDbuMlLan53UTQSpL+UnuRKs9bRHBpx3u21hmVjbN",
	"zUh2+h7QtSp/WCMpQEKV137UVnZxUSkkt0B819WUQgMEDmu495oj952IFuuQ1Yo5nbmuQ7xL0Iy/HwjB",
	"+vP1u2LY5ZuzVhcl0nPxIFZ3BVyb0BRneLAD86i8wvLXJONKt3ziOq/n9A+k8t6HBt+4ltH/DiFwWWuj",
	"1AYZMWYqMpgYM/oryb05aZtXH8eq3Me6VnBD0OTX12+vr5oGc9DWfvB1qpepmaxncAf7pZE53cN1UEdG",
	"kr+xg2wxqRzwGL/QWESRRtXfDQ2afbgxhraAW/uMMlPqQ8lleK79kAH3yCT9uHXcpvbMU/pabRMOKlcB",
	"VmX88Pkp6kMqrzepHYE/IyphnCEb9OIA8O2j2AvHkNQyhLVp+unT9phepEcZ+Db/QEg29GcAdg0rrjbn",
	"Bx47GTKKPUIS+FpqoRwH+0XLvlGgGzJ1svvJt84whGU1Sb5OvWKmNHXydcwbdAGdAg8Bk/uk+YNy0z8H",
	"OlAbE4yBw+S/rDYZeymFqWA/Qc0wbdH9k2oox4oBzcjsgfy/P5P7jW/uMUuYj5Jds+qJzo83woan7tem",
	"Mn5iP8OXZPwEzOr54MFWbDOTfGjjP2FJ6JG22mMSYUn5AvwRHS05mDx7bccwZTF6+ZjN/Nvk5k6A7VVQ",
	"D1I/AsnvWqz2B3S3CZfX321uI4TdVjvTcf3J1uh+JBkxC3bTX/uFgcG9x4XUbq6PB7Rh/grIxn7N50+D",
	"xWnzndpYP+alFCtVN2iVbQ+pElLNuv60ua7jH5O3BTPNLdP76n5JZv4GAxTKfQT2+0TgDzMRuPmN+0AL",
	"YcOO0creVXRoS2OF/h//Vyr27UXYbxMZtwRN1+t/AQAA//8tBBRJoUsAAA==",
}

...
│ password_salt  TEXT           NOT NULL   │       │ archived_at    TIMESTAMPTZ             │
│ mfa_secret     TEXT                      │       │ created_at     TIMESTAMPTZ             │
...
be hard-deleted while any references exist (permissions, comments, public links, audit
